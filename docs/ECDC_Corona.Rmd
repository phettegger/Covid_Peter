...
df1$deaths.per.1e5 <- df1$TotalDeaths / (df1$popData2018 / 1e5)
df1$cases.per.1e5 <- (df1$TotalCases / df1$popData) * 1e5
df1$popData2018 = df1$popData2018 / 1e6
colnames(df1)[8] <- "popData2018.Mio"

df1$letality.percent <- (df1$TotalDeaths / df1$TotalCases) * 100
